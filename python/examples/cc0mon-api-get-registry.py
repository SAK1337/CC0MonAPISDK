"""cc0mon-api-get-registry — list every species in the registry.

Usage::

    python cc0mon-api-get-registry.py
    python cc0mon-api-get-registry.py --limit 5    # show first 5 entries
"""
...
def main(argv: list[str] | None = None) -> int:
    parser = argparse.ArgumentParser(description="List cc0mon species (registry).")
    ...
    logger.info("script exit code=0 total=%d shown=%d", len(species), len(shown))
    return 0
